...
export function ManageCompetitions({ onBack }: ManageCompetitionsProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Sticky Header */}
      <div className="bg-card border-b p-4 md:p-6 flex-shrink-0 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h2 className="flex-1">Manage Competitions</h2>
          </div>
          <Button onClick={handleCreateCompetition} className="w-full" size="lg">
