...
import { Menu, CalendarDays, List, Plus, FileText, Target, Receipt, BarChart3, UserCog, Users, Shield, MapPin, Trophy, LogOut, ChevronLeft, ChevronRight, Home, Search } from 'lucide-react';
...
type ManagementView = 'home' | 'calendar' | 'coaches' | 'squads' | 'swimmers' | 'locations' | 'competitions' | 'addSession' | 'sessionLibrary' | 'drillsLibrary' | 'invoiceTracker' | 'feedbackAnalytics' | 'swimmerProfiles' | 'swimmerProfile';
