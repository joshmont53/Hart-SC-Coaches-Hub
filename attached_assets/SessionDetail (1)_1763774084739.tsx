...
import { ArrowLeft, Pencil, Trash2, CalendarIcon, Clock, MapPin, ChevronRight, Target, Save, Users, Play } from 'lucide-react';
...
export function SessionDetail({
  ...
  const detectedDrills = drills.filter(drill => {
