...
import { sessionTemplates, drills, competitions } from './lib/mockDataExtensions';
...
type ManagementView = 'calendar' | 'coaches' | 'squads' | 'swimmers' | 'locations' | 'competitions' | 'addSession' | 'sessionLibrary' | 'drillsLibrary' | 'invoiceTracker';
