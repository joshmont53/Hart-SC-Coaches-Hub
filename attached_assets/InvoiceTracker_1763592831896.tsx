    ...
    <div className="h-full flex flex-col print:p-8">
      ...
      <div className="print:hidden border-b bg-card p-4 space-y-4 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <h2 className="flex-1 min-w-0">Invoice Tracker</h2>
          <Button onClick={handleExport} variant="outline" size="sm" className="gap-1.5 whitespace-nowrap">
            <Download className="h-4 w-4" />
            <span className="hidden sm:inline">Export Invoice</span>
      ...
      {/* Volunteer Notice */}
      {hourlyRate === 0 && (
        <div className="m-4 p-4 border rounded-lg bg-muted/30 print:hidden">
