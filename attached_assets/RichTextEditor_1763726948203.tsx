...
export function RichTextEditor({ value, onChange, placeholder = 'Enter session content...', templates, onTemplateSelect }: RichTextEditorProps) {
    ...
    <>
      <div className="border rounded-lg bg-card overflow-hidden relative">
        ...
        <div className="border-b bg-muted/50 p-2 space-y-2">
          {/* Row 1: Basic formatting + Template button */}
    ...
    <Dialog open={isTemplateDialogOpen} onOpenChange={setIsTemplateDialogOpen}>
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Select a session template to load into the editor
          </DialogDescription>
        </DialogHeader>
