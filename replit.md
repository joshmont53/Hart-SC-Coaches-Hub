...
- **Intelligent Drill Detection**: AI-powered feature that automatically detects drills mentioned in training session content using GPT-5 Mini. Detected drills are displayed as color-coded stroke-type badges in the session detail view with links to the drills library. Includes fallback case-insensitive substring matching for reliability.
